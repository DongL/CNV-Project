...
ggplot(rva1a3_array[!is.na(rva1a3_array$SEX0101),], aes(x = SEX0101, y = DEFA1.A3.CN, fill = SEX0101)) +
        geom_boxplot() +
#         geom_point(position = "jitter")+
        scale_x_discrete() +
#         facet_grid(.~TXGROUP) +
...
```{r cor-New Scar, fig.height = 4, fig.width = 8}
rva1a3_array$dtVR_3L = rva1a3_array$VR_3L_1301 - rva1a3_array$VR_3L_0101


ggplot(rva1a3_array[!is.na(rva1a3_array$VR_3L_0101), ], aes(y = DEFA1.A3.CN, x = factor(VR_3L_0101))) +
#         geom_point(position = "jitter", fill = "black", col = "blue", size = 2.5) +
        geom_boxplot() +
        scale_y_continuous(breaks = 3:14) +
        scale_x_discrete() +
...
ggplot(rva1a3_array[!is.na(rva1a3_array$VR_3L_1301), ], aes(y = DEFA1.A3.CN, x = factor(VR_3L_1301))) +
        geom_boxplot(aes(fill = factor(VR_3L_1301) )) +
#         geom_point(position = "jitter", fill = "black", col = "blue", size = 2.5) +
        scale_y_continuous(breaks = 3:14) +
        scale_x_discrete() +
#         facet_grid(.~TXGROUP) +
...
ggplot(rva1a3_array[!is.na(rva1a3_array$dtVR_3L), ], aes(y = DEFA1.A3.CN, x = factor(dtVR_3L))) +
        geom_boxplot() +
#         geom_point(position = "jitter", fill = "black", col = "blue", size = 2.5) +
        scale_y_continuous(breaks = 3:14) +
        scale_x_discrete() +
...
#         i = 1:3
        a = rva1a3_array[va[i]]
        b = rva1a3_array[!is.na(a), ][,va[i]]
        ggplot(rva1a3_array[!is.na(a), ], aes(y = DEFA1.A3.CN, x = factor(b))) +
#         geom_point(position = "jitter", fill = "black", col = "blue", size = 2.5) +
        geom_boxplot() +
        xlab(va[i]) +
        scale_y_continuous(breaks = 3:14) +
